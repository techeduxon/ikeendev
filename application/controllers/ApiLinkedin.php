...
class ApiLinkedin extends CI_Controller {
    ...
    public function index($REFERRED_BY=0) { 
		$this->load->library('linkedin', array(
            'access' => "78g4eej5lj647r",//"<your Consumer Key / API Key goes here>",
            'secret' => "e6wIZEpol0HlcELz",//"<your Consumer Secret / Secret Key goes here>",
            'callback' => "https://techeduxon.com/techeduxon/redirect"//"<write here your site name>/receiver" 
        ));
		$data = $this->linkedin->getRequestToken();
