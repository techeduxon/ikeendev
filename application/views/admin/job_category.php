            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Job Category</h2>
                        <ul class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                                ...
                                <li style="list-style: none;"><a href="javascript:void(0);" class="btn btn-info pull-right" data-toggle="modal" data-target="#addmodal">+Add Job Category</a></li>
                        ...
                        <div class="body">
                          ...
                          <form id="header-form" action="<?= base_url().'Adminpanel/Blog/editcareersec2title' ?>" method="post" enctype= multipart/form-data>
                            <div class="row">
                              <div class="col-sm-6 form-group">
                                <label>Title</label>
                                <input type="text" name="title" class="form-control" required="required" value="<?= $career_sec2_sec4['title'] ?>">
                              </div>
                               <div class="col-sm-6 form-group">
                                <label>Sub Title</label>
                                <input type="text" name="subtitle" class="form-control" required="required" value="<?= $career_sec2_sec4['subtitle'] ?>">
                              </div>
                            </div>
                            <button class="btn btn-primary" type="submit">Update</button>
                          </form><br><br><br>
                           <h3 style="color: red">Section 2 Cadrs</h3>
                          <form id="header-form" action="<?= base_url().'Adminpanel/Blog/addcareercards' ?>" method="post" enctype= multipart/form-data>
                            <div class="row">
                              <div class="col-sm-6 form-group">
                                <label>Title</label>
                              ...
                              <div class="col-sm-6 form-group">
                                <label>Image</label>
                                <input type="file" name="single_image" class="form-control" required="required">
                              </div>
                            </div>
                            <button class="btn btn-primary" type="submit">Add</button>
                          </form><br><br><br>
                          <h3 style="color: red">Section 2  Cadrs List</h3>
                          <div class="table-responsive">
                                <table class=" datatable-butt table table-hover table-bordered  js-basic-example dataTable table-custom m-b-0">
                                    ...
                                    <tbody>
                                      <?php if(!empty($career_sec2_cards)){foreach($career_sec2_cards as $val){ ?>
                                        <tr>
                                          <td><?= $val['title'] ?></td>
                                          <td><?=  '<div class="read-more-content1 a'.$val['id'].'" ids="'.$val['id'].'" >'.$val['description'].'</div><a href="javascript:void(0);" idd="a'.$val['id'].'" class="btn dbxshad btn-lg btn-thm2 new-a rounded hide-nshow-read1">Read More</a>';    ?></td>
                                          <td> <img src="<?= base_url().'uploads/home_images/'.$val['image'] ?>" style="height:60px;width:60px;"></td>
                                          <td><button title="Edit"  class="btn btn-teal edit update2" oldimg="<?= $val['image'] ?>"  descp="<?= $val['description'] ?>" tit="<?= $val['title'] ?>" id="<?= $val['id']; ?>'"><i class="fas fa-edit"></i></button> <a class="btn btn-danger" href="<?= base_url().'Adminpanel/Blog/Delete_career_sec2_cards?id='.$val['id'] ?>"><i class="fas fa-trash"></i></td>
                                        </tr>
                                       <?php } } ?>
                                    </tbody>
                                </table>
                          ...
                          <form id="header-form" action="<?= base_url().'Adminpanel/Blog/editcareersec4title' ?>" method="post" enctype= multipart/form-data>
                            <div class="row">
                              <div class="col-sm-6 form-group">
                                <label>Title</label>
                                <input type="text" name="title2" class="form-control" required="required"  value="<?= $career_sec2_sec4['title2'] ?>">
                              </div>
                               <div class="col-sm-6 form-group">
                                <label>Description</label>
                                <input type="text" name="description" class="form-control" required="required" value="<?= $career_sec2_sec4['description'] ?>">
                              </div>
                               <div class="col-sm-6 form-group">
                                <label>Image</label>
                                <input type="file" name="edit_single_image" class="form-control"  >
                                <img src="<?= base_url().'uploads/home_images/'.$career_sec2_sec4['image'] ?>" style="height:60px;width:60px;">
                              </div>
                            </div>
                            <button class="btn btn-primary" type="submit">Update</button>
                          </form><br><br><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                 ...
                 <form class="form-group" id="addform"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 col-sm-12">
                      <textarea class="form-control" name="detail1" id="detail1" placeholder="Enter Detail"></textarea>
                        <script>
...
<div class="modal animated fadeIn  editmodal2" id="assign" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel">Edit </h6>
            ...
            <div class="modal-body">
                  <form class="needs-validation" id="editform2" method="post"  >
                    <div class="row clearfix">
                        ...
                        <div class="form-group">
                         <label for="name">Title</label>
                            <input type="text" class="form-control" name="edit_title" id="edit_title" placeholder="Enter Category" autocomplete="off" >
                        </div>
                    </div>
                     <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                         <label for="name">image</label>
                            <input type="file" class="form-control" name="edit_image" id="edit_image" placeholder="Enter Category" autocomplete="off" >
                            <input type="hidden" name="oldimg" id="oldimg1">
                    ...
                    <div class="col-md-12 col-sm-12">
                      ...
                      <textarea class="form-control" name="descp" id="descp1" placeholder="Enter Detail"></textarea>
...
<script type="text/javascript" language="javascript" >
 $(function(){
        var dataTable = $('.datatable-buttt').DataTable({
           ...
           "order":[],
           "ajax":{
                url:"<?= base_url() . 'DataTable/getJobcategoryList'; ?>",
                type:"POST",
           },
           "columnDefs":[
                {
...
<script>
  $(document).ready(function(){
     $(document).on('submit','#addform',function(){
          ...
          $.ajax({
            url:'<?= base_url().'Adminpanel/Blog/Add_jobcategory' ?>',
            type:'POST',
     ...
     $(document).on('click','.delete',function(){
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.ajax({
                type:'get',
                url:'<?= base_url().'Adminpanel/Blog/Delete_jobcategory' ?>',
                data:{id:id},
                success:function(data){
                  $('.datatable-buttt').DataTable().ajax.reload();
...
$(document).on('click', '.update', function(){
       ...
       swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
           $.ajax({
            type: "POST",
            url: "<?= base_url('Adminpanel/Blog/fetch_single_jobcategory') ?>",
            data: {id:id},
            success: function(response) {
                 $('#editform').trigger('reset');
                    var obj = $.parseJSON(response);
                     ...
                     $("#ca_id").val(obj['id']);
                     CKEDITOR.instances.detail1.setData(obj['detail'] );
    ...
    $(':input[type="submit"]').prop('disabled', true);
     $.ajax({
          type: "POST",
          url: "<?=base_url('Adminpanel/Blog/update_jobcategory')?>",
          data:new FormData(this),
          contentType:false,
          processData:false,
          success: function(data) {
    ...
    $(':input[type="submit"]').prop('disabled', true);
     $.ajax({
          type: "POST",
          url: "<?=base_url('Adminpanel/Blog/update_jobcategory2')?>",
          data:new FormData(this),
          contentType:false,
          processData:false,
          success: function(data) {
