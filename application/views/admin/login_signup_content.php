            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Login Signup Content</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url().'Adminpanel/index'?>"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item active">Login Signup Content</li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                             ...
                             <h3 style="color: red">Login Content</h3>
                          <form id="header-form" action="<?= base_url().'Adminpanel/Content/editlogin_content' ?>" method="post" enctype= multipart/form-data>
                            <div class="row">
                              <div class="col-sm-6 form-group">
                                <label>Title</label>
                                <input type="text" name="title" class="form-control" value="<?= $login_content['login_title'] ?>" >
                              </div>
                              <div class="col-sm-6 form-group">
                                <label>Image</label>
                                <input type="file" name="single_image" class="form-control" >
                                <input type="hidden" name="old_image" value="<?= $login_content['login_image'] ?>">
                                <img src="<?= base_url().'uploads/home_images/'.$login_content['login_image'] ?>" style="height:60px;width:60px;">
                              </div>
                               <div class="col-sm-12 form-group">
                                <label>Description</label>
                                <input type="text" name="description" class="form-control"  value="<?= $login_content['login_description'] ?>">
                              </div>

                            </div>
                            <button class="btn btn-primary" type="submit">Update</button>
                          </form><br><br><br>
                          <h3 style="color: red">Signup Content</h3>
                          <form id="header-form" action="<?= base_url().'Adminpanel/Content/editsignup_content' ?>" method="post" enctype= multipart/form-data>
                            <div class="row">
                              <div class="col-sm-6 form-group">
                                <label>Title</label>
                                <input type="text" name="title" class="form-control" value="<?= $login_content['signup_title'] ?>" >
                              </div>
                              <div class="col-sm-6 form-group">
                                <label>Image</label>
                                <input type="file" name="single_image" class="form-control" >
                                <input type="hidden" name="old_image" value="<?= $login_content['signup_image'] ?>">

                                <img src="<?= base_url().'uploads/home_images/'.$login_content['signup_image'] ?>" style="height:60px;width:60px;">
                              </div>
                               <div class="col-sm-12 form-group">
                                <label>Description</label>
                                <input type="text" name="description" class="form-control"  value="<?= $login_content['signup_description'] ?>">
                              </div>
