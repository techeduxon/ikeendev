            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Sub Category</h2>
                        <ul class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                                ...
                                <li style="list-style: none;"><a href="javascript:void(0);" class="btn btn-info pull-right" data-toggle="modal" data-target="#addmodal">Add Sub Category</a></li>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel">Add Sub Category</h6>
            </div>
                     ...
                     <div class="col-md-4 col-sm-12">
                        <div class="form-group">    
                         <label for="name">Sub Category</label>                                
                            <input type="text" class="form-control" name="subcategory" id="subcategory" placeholder="Enter Sub Category" autocomplete="off" >
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">    
                         <label for="name">Comment</label>                                
                            <textarea type="text" class="form-control" name="comment" id="comment" placeholder="Enter Comment" autocomplete="off" ></textarea>
                 ...
                 <form class="form-group" id="addform"  method="post" enctype="multipart/form-data">
                    <div class="row clearfix">
                     ...
                     <div class="col-md-4 col-sm-12">
                        <div class="form-group">    
                         <label for="name">Sub Category</label>                                
                            <input type="text" class="form-control" name="edit_subcategory" id="edit_subcategory" placeholder="Enter Sub Category" autocomplete="off" >
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">    
                         <label for="name">Comment</label>                                
                            <textarea type="text" class="form-control" name="edit_comment" id="edit_comment" placeholder="Enter Comment" autocomplete="off" ></textarea>
...
$(document).ready(function (){
        ...
        $("#editform").validate({
            ...
            messages: {
                ...
                edit_subcategory:  "Please Enter Subcategory",
                edit_comment:  "Please Enter Comment",
...
<script type="text/javascript" language="javascript" >  
 $(function(){ 
        var dataTable = $('.datatable-buttt').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= base_url() . 'DataTable/getSubCategoryList'; ?>",  
                type:"POST",
       ...
       swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
           $.ajax({
            type: "POST",
            url: "<?=base_url('fetch_single_subcategory')?>",
            data: {id:id},
            success: function(response) {
                 $('#editform').trigger('reset');
                    var obj = $.parseJSON(response);
                     ...
                     $("#edit_subcategory").val(obj['subcategory']);
