            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Course List Details</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url().'Adminpanel/index'?>"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item active">Course List Details</li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                                ...
                                <li style="list-style: none;"><a href="javascript:void(0);" class="btn btn-info pull-right" data-toggle="modal" data-target="#addmodal">Add Course List Details</a></li>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                         <label for="name"> URL </label>
                            <input type="text" class="form-control" name="url" id="url" placeholder="Enter URL" autocomplete="off" >
                     ...
                     <!--  <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                         <label for="name"> Content </label>
                            <textarea type="text" class="form-control" name="content" id="content" placeholder="Enter Title" value=" " autocomplete="off" ></textarea>

                        </div>
                    </div> -->
                </div>
                <input type="hidden" name="edu_det_id" id="edu_det_id" value="<?= $_GET['id'] ?>">
                   ...
                   <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12">
                     ...
                     <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                         <label for="name"> URL </label>
                            <input type="text" class="form-control" name="edit_url" id="edit_url" placeholder="Enter URL" autocomplete="off" >
                      ...
                      <!-- <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                         <label for="name"> Content </label>
                            <textarea type="text" class="form-control" name="edit_content" id="edit_content" placeholder="Enter Content" autocomplete="off" ></textarea>

                        </div>
                    </div> -->
                </div>
                <input type="hidden" name="ca_id" id="ca_id">
                <input type="hidden" name="edu_det" id="edu_det" value="<?= $_GET['id'] ?>">
...
<script type="text/javascript" language="javascript" >
 $(function(){
        var dataTable = $('.datatable-buttt').DataTable({
           ...
           "order":[],
           "ajax":{
                url:"<?= base_url() . 'DataTable/getCourselistdetdetList?id='; ?>"+<?= $_GET['id'] ?>,
                type:"POST",
...
<script>
  $(document).ready(function(){
      $(document).on('submit','#addform',function(){
          ...
          $.ajax({
            url:'<?= base_url().'Add_course_list_det_det' ?>',
            type:'POST',
            data:$(this).serialize(),
     ...
     $(document).on('click','.delete',function(){
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.ajax({
                type:'get',
                url:'<?= base_url().'Delete_course_list_det_det' ?>',
                data:{id:id},
                success:function(data){
...
$(document).on('click', '.update', function(){
       ...
       swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
           $.ajax({
            type: "POST",
            url: "<?=base_url('fetch_single_course_list_det_det')?>",
            data: {id:id},
    ...
    $(':input[type="submit"]').prop('disabled', true);
     ...
     $.ajax({
          type: "POST",
          url: "<?=base_url('update_course_list_det_det')?>",
          data:$(this).serialize(),
          success: function(data) {
            if (data == 1) {
