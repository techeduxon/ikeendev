...
.new-tabl th:nth-child(4),.new-tabl td:nth-child(4){
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>News And Article</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url().'Adminpanel/index'?>"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item active">News And Article</li>
                        </ul>
                    </div>            
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                                ...
                                <li style="list-style: none;"><a href="javascript:void(0);" class="btn btn-info pull-right" data-toggle="modal" data-target="#addmodal">Add News And Article</a></li>
                        ...
                        <div class="body">
                           ...
                           <input type="text" style=" position: absolute;left: -999em;" name="cpText" id="cpText">
                            <div class="table-responsive">
                                <table class="new-tabl datatable-buttt table table-hover table-bordered  js-basic-example dataTable table-custom m-b-0">
                                    <thead>
...
$(document).ready(function (){
        ...
        $("#addform").validate({
            ...
            messages: {
                title1: "Please Enter Title 1",
                title2: "Please Enter Title 2",
...
<script type="text/javascript" language="javascript" >  
 $(function(){ 
        var dataTable = $('.datatable-buttt').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= base_url() . 'DataTable/getNews_and_articleList'; ?>",  
                type:"POST",
...
<script>
  $(document).ready(function(){
     $(document).on('submit','#addform',function(){ 
          ...
          $.ajax({ 
            url:'<?= base_url().'Add_news_and_article' ?>',
            type:'POST',
     ...
     $(document).on('click','.delete',function(){
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.ajax({
                type:'get',
                url:'<?= base_url().'Delete_news_and_article' ?>',
                data:{id:id},
                success:function(data){
...
$(document).on('click', '.update', function(){
       ...
       swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
           $.ajax({
            type: "POST",
            url: "<?=base_url('fetch_single_news_and_article')?>",
            data: {id:id},
    ...
    $(':input[type="submit"]').prop('disabled', true);
     ...
     $.ajax({
          type: "POST",
          url: "<?=base_url('update_news_and_article')?>",
          data:new FormData(this),
          contentType:false,
          processData:false,
          success: function(data) {
