            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Trainer List</h2>
                        <ul class="breadcrumb">
...
<div class="modal animated fadeIn" id="viewmodal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel">Profile Data</h6>
            </div>
            <div class="modal-body">
                     <div>
                       <p><b>Title</b> :<span id="title"></span></p>
                       <p><b>Course_label</b> :<span id="course_label"></span></p>
                       <p><b>Instructor</b> :<span id="instructor"></span></p>
                       <p><b>Language</b> :<span id="language"></span></p>
                       <p><b>Category</b> :<span id="category"></span></p>
                       <p><b>Class</b> :<span id="class"></span></p>
                       <p><b>Hours</b> :<span id="hours"></span></p>
                       <p><b>Price</b> :<span id="price"></span></p>
                       <p><b>Day</b> :<span id="day"></span></p>
                       <p><b>Month</b> :<span id="month"></span></p>
...
<script type="text/javascript" language="javascript" >  
 $(function(){ 
        var dataTable = $('.datatable-buttt').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= base_url() . 'DataTable/getTrainerList'; ?>",  
                type:"POST",
      ...
      event.preventDefault();
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.ajax({
                type:'get',
                url:'<?= base_url().'Adminpanel/Content/Delete_trainer_list' ?>',
                data:{id:id},
     ...
     $(document).on('click','.view',function(){
      event.preventDefault();
        var id = $(this).attr('id');
            ...
            $.ajax({
                type:'get',
                url:'<?= base_url().'Adminpanel/Content/get_trainer_profile' ?>',
                data:{id:id},
                success:function(data){
                    var obj = JSON.parse(data)
                      $('#title').html(obj.title)
                      $('#course_label').html(obj.course_label)
                      $('#instructor').html(obj.instructor)
