        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                        ...
                        <div class="body">
                            <div class="teb-links">
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0);" class="btn btn-outline-info active" ><i class="la la-file-video-o"></i> Batches</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                           <li style="list-style: none;"><a href="javascript:void(0);" class="btn btn-info pull-right" data-toggle="modal" data-target="#addmodal">Add Batch</a></li>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel">Add New Batch</h6>
            </div>
                     ...
                     <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                         <label for="name"> Type </label>
                            <input type="text" class="form-control" name="type" id="type" placeholder="Enter Type " autocomplete="off" >
