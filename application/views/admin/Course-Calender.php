            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Course Calender</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url().'Adminpanel/index'?>"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item active">Course Calender</li>
                        </ul>
                    </div>
                          ...
                          <form id="header-form" action="<?= base_url().'Adminpanel/Blog/editcareersec2title' ?>" method="post" enctype= multipart/form-data>
                            <div class="row">
                             ...
                             <button class="btn btn-primary" type="submit">Update</button>
                                ...
                                <li style="list-style: none;"><a href="javascript:void(0);" class="btn btn-info pull-right" data-toggle="modal" data-target="#addmodal">+Add Course Calender</a></li>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                         <label for="name">Title</label>
                            <input type="text" class="form-control" name="title" id="category" placeholder="Enter Title" autocomplete="off" >
                      ...
                      <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                         <label for="name">Image</label>
                            <input type="file" class="form-control" name="single_image" id="single_image"  autocomplete="off" >
                        </div>
                    </div>
                </div>
                 ...
                 <form class="form-group" id="addform"  method="post" enctype="multipart/form-data">
                    <div class="row clearfix">
                      ...
                      <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                         <label for="name">Image</label>
                            <input type="file" class="form-control" name="edit_single_image" id="edit_single_image"  autocomplete="off" >
...
<div class="modal animated fadeIn  addContant" id="assign" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                 <form class="form-group" id="detailForm"  method="post" enctype="multipart/form-data">
                  <input type="hidden" name="trainig_id" id="trainig_id">
                    <div class="row clearfix">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="month">Month</label>
                          <input type="text" class="form-control" name="month" id="month" placeholder="Enter Month" autocomplete="off" >
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="mode" id="mode" placeholder="Enter Mode" autocomplete="off" >
                        </div>
                      </div>
        ...
        $('#detailForm').validate({
          errorClass: "my-error-class",
            ...
            messages: {
                ...
                start_date: "Please select atart date",
...
<script type="text/javascript" language="javascript" >
 $(function(){
        var dataTable = $('.datatable-buttt').DataTable({
           ...
           "order":[],
           "ajax":{
                url:"<?= base_url() . 'DataTable/getTrainingList'; ?>",
                type:"POST",
           },
           "columnDefs":[
                {
...
<script>
  $(document).ready(function(){
     $(document).on('submit','#addform',function(){
          ...
          $.ajax({
            url:'<?= base_url().'Adminpanel/Blog/addTraining' ?>',
            type:'POST',
     ...
     $(document).on('click','.delete',function(){
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.ajax({
                type:'get',
                url:'<?= base_url().'Adminpanel/Blog/deleteTraining' ?>',
                data:{id:id},
                success:function(data){
                  $('.datatable-buttt').DataTable().ajax.reload();
...
$(document).on('click', '.update', function(){
       ...
       swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
           $.ajax({
            type: "POST",
            url: "<?= base_url('Adminpanel/Blog/fetch_single_training') ?>",
            data: {id:id},
    ...
    $(':input[type="submit"]').prop('disabled', true);
     $.ajax({
          type: "POST",
          url: "<?=base_url('Adminpanel/Blog/editTraining')?>",
          data:new FormData(this),
          contentType:false,
          processData:false,
          success: function(data) {
  ...
  $(document).on('submit', '#detailForm', function(){
    $(':input[type="submit"]').prop('disabled', true);
     $.ajax({
          type: "POST",
          url: "<?=base_url('Adminpanel/Blog/addDetailForm')?>",
          data:new FormData(this),
          contentType:false,
          processData:false,
          success: function(data) {
