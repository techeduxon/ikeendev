        ...
        <div class="container-fluid">
                    ...
                    <div class="breadcrumb-content dashboard-bread-content d-flex align-items-center justify-content-between">
                        <div class="user-bread-content d-flex align-items-center">
                            ...
                            <div class="section-heading">
                                <h2 class="section__title font-size-30"><?= $data->name ?></h2>
            ...
            <div class="row mt-4">
                <div class="col-lg-12">
                    <div class="aj-tebs">
                        <ul>
                            <li><a href="<?= base_url().'My-Account'?>" class="active" > Profile</a></li>
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="profile-detail pb-5">
                        <ul class="list-items">
                            <li><span class="profile-name">Registration Date:</span><span class="profile-desc"><?= date('d M Y H:i:s',strtotime($data->created_at)) ?></span></li>
                            <li><span class="profile-name">Name:</span><span class="profile-desc"><?= $data->name ?></span></li>
                            <li><span class="profile-name">User Name:</span><span class="profile-desc"><?= $data->email ?></span></li>
                            <li><span class="profile-name">Email:</span><span class="profile-desc"><?= $data->email ?></span></li>
                            <li><span class="profile-name">Phone Number:</span><span class="profile-desc"><?= $data->contact ?></span></li>
...
<script src="<?= base_url().'assets/user-assets/' ?>js/animated-skills.js"></script>
