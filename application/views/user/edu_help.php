...
<section class="edu-help-sec">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="row">
                        <?php if(!empty($edu_help)){  ?>
                            <?php foreach ($edu_help as $key => $value) { ?>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                            <?php $edu_help_det=$this->User_model->get_all_where('*','tbl_edu_help_det',array('edu_id'=>$value['id']),'',''); ?>
                            
                        <div class="help-box">
                            <div class="header-se text-center">
                                <img src="<?= base_url().'uploads/edu_images/'.$value['image'] ?>" style="height: 40px;width:50px;">
                                <h3 ><?= $value['title'] ?></h3>
                            </div>
                           
                         <div class="accordion accordion-shared accordion-shared-2" id="accordionExample">
                            <?php if(!empty($edu_help_det)){ ?>
                                <?php foreach ($edu_help_det as $key => $val) { ?>
                    ...
                    <h4 class="text-center mb-3">Contact Us For Help</h4>
                     ...
                     <form id="contactform" method="POST" >
                        ...
                        <div class="col-lg-12">
                            <div class="input-box">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="contact" maxlength="13" minlength="7" placeholder="Phone No." onkeypress="return isNumber(event)">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
